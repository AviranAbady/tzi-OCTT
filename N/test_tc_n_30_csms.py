"""
TC_N_30 - Clear Customer Information - Clear and report + data
...
Purpose:
    ...
    handles the NotifyCustomerInformation sent back by the Charging Station.
...
async def test_tc_n_30():
    ...
    logging.info("TC_N_30 step 1-2 completed: CustomerInformationResponse Accepted")
    ...
    logging.info("TC_N_30 completed successfully")
    start_task.cancel()
    await ws.close()
