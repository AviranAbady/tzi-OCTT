"""
TC_N_28 - Get Customer Information - Accepted + no data
...
Description:
    ...
    The Charging Station has no data but still sends NotifyCustomerInformation with minimal data.
...
Purpose:
    ...
    CSMS correctly handles a NotifyCustomerInformation with no meaningful data.
...
async def test_tc_n_28():
    ...
    logging.info("TC_N_28 step 1-2 completed: CustomerInformationResponse Accepted")
    ...
    logging.info("TC_N_28 completed successfully")
    start_task.cancel()
    await ws.close()
