"""
TC_K_30 - Get Charging Profile - EvseId > 0
...
Purpose:
    To verify if the CSMS is able to request charging profiles installed on a specific EVSE and read in the
...
async def test_tc_k_30():
    ...
    logging.info("TC_K_30 completed successfully")
    start_task.cancel()
    await ws.close()
