"""
TC_K_35 - Get Charging Profile - EvseId > 0 + chargingProfilePurpose
...
Purpose:
    To verify if the CSMS is able to request charging profiles with a specific chargingProfilePurpose
...
async def test_tc_k_35():
    ...
    logging.info("TC_K_35 completed successfully")
    start_task.cancel()
    await ws.close()
