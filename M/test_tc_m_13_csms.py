"""
TC_M_13 - Retrieve certificates from Charging Station - ManufacturerRootCertificate
...
Purpose:
    To verify if the CSMS is able to retrieve the hashData from all ManufacturerRootCertificate
...
@pytest.mark.asyncio
async def test_tc_m_13():
    """Retrieve certificates from Charging Station - ManufacturerRootCertificate."""
    cp_id = BASIC_AUTH_CP
    ...
    # Tool validation: certificateType must be ManufacturerRootCertificate
    ...
    logging.info("TC_M_13 completed successfully")
    start_task.cancel()
    await ws.close()
