"""
TC_O_14 - Set Display Message - Remove message after EndTime
...
Purpose:
    To verify if the CSMS is able to send the request with a endTime according to the DisplayMessage
...
async def test_tc_o_14():
    ...
    logging.info("TC_O_14 completed successfully")
    start_task.cancel()
    await ws.close()
