"""
TC_M_01 - Install CA certificate - CSMSRootCertificate
...
Purpose:
    To verify if the CSMS is able to request a Charging Station to install a new CSMSRootCertificate.
...
async def test_tc_m_01():
    ...
    # CS responded with Accepted (handled by on_install_certificate handler)

    logging.info("TC_M_01 completed successfully")
    start_task.cancel()
    await ws.close()
