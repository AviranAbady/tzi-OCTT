...
CONFIGURED_CONFIGURATION_SLOT = os.environ.get('CONFIGURED_CONFIGURATION_SLOT')
CONFIGURED_MESSAGE_TIMEOUT = os.environ.get('CONFIGURED_MESSAGE_TIMEOUT')
CONFIGURED_OCPP_CSMS_URL = os.environ.get('CONFIGURED_OCPP_CSMS_URL')
CONFIGURED_OCPP_INTERFACE = os.environ.get('CONFIGURED_OCPP_INTERFACE')
CONFIGURED_SECURITY_PROFILE = os.environ.get('CONFIGURED_SECURITY_PROFILE')
